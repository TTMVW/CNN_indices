...
#
print(f"Word 'data' appeared {model.wv.get_vecattr('data', 'count')} times in the training corpus.")
...
#
vector = model.infer_vector(['conceptual', 'leads', 'to', 'logical', 'and', 'physical'])
print(vector)
